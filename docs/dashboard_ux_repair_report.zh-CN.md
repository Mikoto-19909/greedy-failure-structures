...
发布分支从主线 `dcfd2221` 整理五个界面提交，保留主线已有的 HTTP 拒绝回归与开发收口文档；以下原验收记录仍对应原实现提交。
旧界面工作区的七个未提交文件已另行比较，入门、三种方案、预览、指标说明与窄屏行为均被发布分支覆盖；原文件与验证材料已有本地归档，旧工作区已收尾。
界面修复已由 [PR #64](https://github.com/Mikoto-19909/greedy-failure-structures/pull/64) 合并到主线，合并提交为 `8e04db273b664a6d0ee3bbeb40227b4ecabf138f`。
