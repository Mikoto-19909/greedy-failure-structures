...
R3 has a verified feasibility probe and confirmation design, with confirmation and R4 still unexecuted. The
...
- [`greedy_failure_research_plan.zh-CN.md`](greedy_failure_research_plan.zh-CN.md):
  ...
  (Simplified Chinese; R1 and R2 completed, R3 confirmation and R4 unexecuted)
- [`r2_r3_integrated_plan.zh-CN.md`](r2_r3_integrated_plan.zh-CN.md):
  ...
  the current batch has completed R2 and R3 feasibility/F3, without confirmation execution
