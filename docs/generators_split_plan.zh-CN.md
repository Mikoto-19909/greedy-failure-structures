...
检查注册表中每个 spec 的名称、版本、参数定义、默认值、factory 和迭代顺序。
...
重点核对 `config.py`、`benchmark.py`、`cli.py`、`stressor_audit.py` 和包根 `__init__.py`。
