...
class GeneratorTests(unittest.TestCase):
    ...
    def test_registry_and_direct_calls_are_equivalent(self) -> None:
        ...
        direct_instances = {
            ...
            "controlled_high_overlap": controlled_high_overlap(
                universe_size=72,
                set_count=8,
                k=3,
                set_size=8,
            ...
            "controlled_clustered": controlled_clustered(
                universe_size=80,
                set_count=8,
                k=3,
                clusters=2,
            ...
            "controlled_duplicate": controlled_duplicate(
                universe_size=48,
                set_count=8,
                k=3,
                set_size=5,
            ...
            "controlled_dominated": controlled_dominated(
                universe_size=40,
                set_count=8,
                k=3,
                anchor_size=6,
            ...
            "controlled_adversarial": controlled_adversarial_greedy_trap(
                block_size=8,
                distractor_count=4,
                trap_count=5,
                seed=seed,
