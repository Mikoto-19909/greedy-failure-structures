...
The [production backend plan](../docs/r2_production_backends_plan.zh-CN.md)
defines the proposed CPU/CUDA interface, timing, fallback and checkpoint boundaries;
these production options are not implemented yet.
